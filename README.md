...
### Prerequisites
- Python 3.10–3.13 (required: `kokoro-onnx>=0.4.7` needs Python ≥ 3.10 and supports only up to 3.13. On rolling-release distros with Python 3.14 as default, create the venv with an older Python, e.g. `uv venv --python 3.13 venv` after `uv python install 3.13`.)
